...
class RoleMixin:
    ...
    def role_display(self):
        ...
        if self in current_org.get_org_cies():
            roles.append(str(_('CIE')))
        return " | ".join(roles)
    ...
    @property
    def is_super_cie(self):
        return self.role == 'CIE'
    ...
    def cie_orgs(self):
        from orgs.models import Organization
        return Organization.get_user_cie_orgs(self)
    ...
    @lazyproperty
    def is_org_cie(self):
        if self.is_super_cie or self.related_cie_orgs.exists():
            return True
        else:
            return False
    ...
    @lazyproperty
    def can_cie_current_org(self):
        return current_org.can_cie_by(self)
    ...
    @lazyproperty
    def can_admin_or_cie_current_org(self):
        return self.can_admin_current_org or self.can_cie_current_org
