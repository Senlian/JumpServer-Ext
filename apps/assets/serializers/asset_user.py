...
class AssetUserReadSerializer(AssetUserWriteSerializer):
    id = serializers.CharField(read_only=True, source='asset_id', label=_("ID"))
    union_id = serializers.CharField(read_only=True, label=_("UNION_ID"))
    ...
    class Meta(AssetUserWriteSerializer.Meta):
        ...
        fields = [
            'id', 'union_id', 'username', 'password', 'private_key', "public_key",
