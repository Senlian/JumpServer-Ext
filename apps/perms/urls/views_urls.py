...
urlpatterns = [
    ...
    # jenkins-permission
    path('jenkins-permission/', views.JenkinsPermissionListView.as_view(), name='jenkins-permission-list'),
    path('jenkins-permission/create/', views.JenkinsPermissionCreateView.as_view(), name='jenkins-permission-create'),
    path('jenkins-permission/<uuid:pk>/update/', views.JenkinsPermissionUpdateView.as_view(),name='jenkins-permission-update'),
    path('jenkins-permission/<uuid:pk>/', views.JenkinsPermissionDetailView.as_view(), name='jenkins-permission-detail'),
    path('jenkins-permission/<uuid:pk>/user/', views.JenkinsPermissionUserView.as_view(), name='jenkins-permission-user-list'),
    path('jenkins-permission/<uuid:pk>/job/', views.JenkinsPermissionJobView.as_view(), name='jenkins-permission-job-list'),
