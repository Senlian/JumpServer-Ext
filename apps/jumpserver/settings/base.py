...
INSTALLED_APPS = [
    ...
    'jms_oidc_rp', #OpenID 验证
    'rest_framework', # api接口
    'rest_framework_swagger', # 生成api文档,SWAGGER_SETTINGS定义获取token方式
    'drf_yasg', # 生成api文档，目前用的这个
    'django_cas_ng', # 单点登录,当前没有启用，配置文件AUTH_CAS开启单点登录，但是有问题没解决
    'channels', #实时通讯
    'django_filters', #定义过滤字段
    'bootstrap3', #bootstrap3 相关
    'captcha', # 验证码
    'django_celery_beat', #celery定期任务
    'django.contrib.auth',
...
MIDDLEWARE = [
    ...
    'django_cas_ng.middleware.CASMiddleware', #单点登录中间件
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cis.context_processor.jenkins_processor',
            ],
        },
    },
]
...
MEDIA_ROOT = os.path.join('/home/data/nginx/www', 'data', 'media').replace('\\', '/') + '/'
