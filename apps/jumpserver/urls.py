...
api_v1 = [
    ...
    path('cis/', include('cis.urls.api_urls', namespace='api-cis')),
]
...
app_view_patterns = [
    ...
    path('cis/', include('cis.urls.views_urls', namespace='cis')),
...
# from rest_framework.documentation import include_docs_urls #生成API接口文档
if settings.DEBUG:
    urlpatterns += [
        ...
        # path('ddocs/',include_docs_urls(title='test222')),
    ]
