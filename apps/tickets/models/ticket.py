...
#         (STATUS_CLOSED, _("Closed"))
#     )
#     user =models.ForeignKey('users.User', on_delete=models.CASCADE, null=True, verbose_name=_("User"), related_name='assignees')
#     Ticket =models.ForeignKey(Ticket, on_delete=models.CASCADE, null=True, verbose_name=_("Ticket"), related_name='assignees')
#     status = models.CharField(choices=STATUS_CHOICES, max_length=16, default='open')